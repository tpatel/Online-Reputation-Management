...
In order to extract the will of the people, to be able to find the best movie, adapt ones business strategy to better appeal to ones customers or for more sinister purposes such as trying to control the inhabitants of an authoritarian government.

To directly read someones more advanced thoughts is however still far from possible.
However how, and what, a person chooses to communicate very often do reflect what the person thinks.
...
This will get us a position somewhere in a [0-100] range where 0 would be a fully negative opinion and 100 a fully positive. We made the assumption here that the tweets that were classified as ``neutral'' was tweets about a brand that contained no opinion.
