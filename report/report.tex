...
Twitter is the ideal place for analyzing people's opinions of a brand. 
...
\centerline{\includegraphics[scale=0.4]{../img/man1.png}}
\vspace{-0.7cm}
...
\vspace{-0.6cm}
\centerline{\includegraphics[scale=0.4]{../img/full1.png}}
\vspace{-0.6cm}
...
The resulting computation comes from tries and error when applying the function to our dataset, and seems to give good results. More research can be done in this part of our study in order to bring a deeper analysis of our results.
